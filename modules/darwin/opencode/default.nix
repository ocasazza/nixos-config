    ...
    home.file.".config/opencode/oh-my-openagent.jsonc".text = ''
      {
        ...
        "agents": {
          "sisyphus": { "model": "litellm/desk-nxst-001-qwen3-coder" },
          "prometheus": { "model": "litellm/desk-nxst-001-qwen3-coder" },
          "atlas": { "model": "litellm/desk-nxst-001-qwen3-coder" },
          "explore": { "model": "litellm/desk-nxst-001-qwen3-coder" }
        },
        "disabled_hooks": [],
        "mcp": {
      ...
      (pkgs.formats.json { }).generate "opencode-user.json"
        {
          ...
          model = "litellm/desk-nxst-001-qwen3-coder";
